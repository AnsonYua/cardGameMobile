...
const SCENARIO_PRESET_GROUPS = {
  ...
  GD01: [
    ...
    "GD01/GD01-007/destroyed_draw_1_if_another_oz_unit_in_play.json",
    "GD01/GD01-007/destroyed_draw_1_if_another_oz_unit_in_play_manual_battle.json",
    "GD01/GD01-008/deploy_choose_rested_enemy_unit_deal_1_damage",
    "GD01/GD01-008/deploy_choose_rested_enemy_unit_deal_1_damage_manual_flow.json",
    "GD01/GD01-009/deploy_choose_white_base_team_unit_grant_high_maneuver",
    "GD01/GD01-010/when_paired_choose_enemy_unit_hp_le_3_rest.json",
    "GD01/GD01-010/when_paired_choose_enemy_unit_hp_le_3_rest_manual_flow.json",
    "GD01/GD01-012/when_paired_choose_enemy_unit_hp_le_3_rest.json",
    "GD01/GD01-012/when_paired_choose_enemy_unit_hp_le_3_rest_manual_flow.json",
    "GD01/GD01-014/during_link_activate_action_once_per_turn_choose_1_unit_recover_1_hp.json",
    "GD01/GD01-015/attack_choose_friendly_unit_recover_1_hp.json",
    "GD01/GD01-016/hand_cost_reduction_1_if_earth_federation_units_ge_2.json",
    ...
    "GD01/GD01-024/high_maneuver_unblockable_then_deploy_damage_all_lv5_or_lower.json",
    "GD01/GD01-025/pair_place_rested_resource_then_first_strike",
    "GD01/GD01-026/during_pair_destroyed_deploy_rested_chars_zaku_ii_token.json",
    "GD01/GD01-027/deploy_blocker_aoe_with_10_zeon_trash_then_breach4_on_destroy.json",
    "GD01/GD01-027/deploy_if_zeon_trash_ge_10_damage_all_blockers_then_breach4_on_battle_destroy_manual_flow.json",
    "GD01/GD01-028/deploy_optional_maganac_from_hand_manual_flow.json",
    "GD01/GD01-029/attack_destroy_lv3_blocker_then_breach4_on_battle_destroy.json",
    "GD01/GD01-029/attack_manual_flow_blocker_choice_then_breach4_on_destroy.json",
    "GD01/GD01-030/attack_destroy_enemy_unit_then_breach2_hits_first_shield.json",
    "GD01/GD01-030/attack_manual_flow_destroy_enemy_unit_then_breach2_hits_first_shield.json",
    "GD01/GD01-032/when_paired_zeon_pilot_destroy_enemy_blocker_level2_or_lower_manual_flow.json",
    "GD01/GD01-034/during_pair_battle_destroy_triggers_breach3_hits_first_shield.json",
    "GD01/GD01-038/deploy_if_enemy_units_ge_5_damage_all_enemy_units.json",
    "GD01/GD01-038/deploy_if_enemy_units_ge_5_damage_all_enemy_units_manual_flow.json",
    "GD01/GD01-039/deploy_scry_top_1_choose_bottom",
    "GD01/GD01-039/deploy_scry_top_1_choose_top",
    "GD01/GD01-041/attack_destroy_enemy_unit_then_breach3_hits_first_shield.json",
    "GD01/GD01-041/attack_manual_flow_destroy_enemy_unit_then_breach3_hits_first_shield.json",
    "GD01/GD01-042/attack_target_active_enemy_unit_level_2_or_lower_active_gate_manual_flow.json",
    "GD01/GD01-042/attack_target_active_enemy_unit_level_2_or_lower_manual_flow.json",
    ...
    "GD01/GD01-051/deploy_choose_enemy_unit_deal_1_damage_manual_flow",

...
import { TopDeckSelectionReviewDialog } from "../ui/TopDeckSelectionReviewDialog";
...
export function createTimedDialogs(
  ...
  return {
    ...
    topDeckSelectionReviewDialog: new TopDeckSelectionReviewDialog(scene, timerController),

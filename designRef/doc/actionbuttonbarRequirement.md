...
after end with blocker selection phase, it will go into Action-step phase. (if opponent doesnt have )
if opponent has blocker, flow will like this 
player trigger attack -> blocker selection phase -> action step -> summarize of the battle
